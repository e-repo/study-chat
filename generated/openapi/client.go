...
// NewPostUsersRequest calls the generic CreateUser builder with application/json body
...
// NewPostUsersRequestWithBody generates requests for CreateUser with any type of body
